...
namespace OptKit.Wpf.UI.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new OptKit.Wpf.UI.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private static object TryGetResource(OptKit.Wpf.UI.Theme theme, string key)
        {
            if (theme == null)
            {
        ...
        private static OptKit.Wpf.UI.Theme DetectTheme(BaseMetroDialog dialog)
        {
            if (dialog == null)
            {
                return null;
