...
using OptKit.Wpf.UI.AvalonDock.Controls;
using System.Windows.Input;
using System.Collections;
using System.Collections.Specialized;
using System.Windows.Data;
using System.Windows.Threading;
using OptKit.Wpf.UI.AvalonDock.Themes;

namespace OptKit.Wpf.UI.AvalonDock
{
  ...
  public class DockingManager : Control, IOverlayWindowHost//, ILogicalChildrenContainer
  {
    ...
    /// </summary>
    public static readonly DependencyProperty ThemeProperty = DependencyProperty.Register( "Theme", typeof(AvalonDockTheme), typeof( DockingManager ),
    ...
    /// </summary>
    public AvalonDockTheme Theme
    {
      get
      {
        return (AvalonDockTheme)GetValue( ThemeProperty );
      }
      set
      {
    ...
    {
      var oldTheme = e.OldValue as AvalonDockTheme;
      var newTheme = e.NewValue as AvalonDockTheme;
