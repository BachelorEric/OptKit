...
namespace OptKit.Wpf.UI
{
    ...
    {
        private const string BaseResourcePath = "pack://application:,,,/OptKit.Wpf.UI;component/Styles/Themes/";
        ...
        public static bool AddTheme(Uri resourceAddress)
        {
        ...
        /// <returns>true if the app theme does not exists and can be added.</returns>
        public static bool AddTheme(ResourceDictionary resourceDictionary)
        {
        ...
        /// <returns>The <see cref="Theme"/> or <c>null</c>, if the theme wasn't found.</returns>
        public static Theme GetTheme(ResourceDictionary resources)
        {
            if (resources == null)
            {
        ...
        /// </remarks>
        public static Theme GetInverseTheme(Theme theme)
        {
            if (theme == null)
            {
        ...
        /// </summary>
        [SecurityCritical]
        public static void ChangeTheme(Application app, string themeName)
        {
            if (app == null)
            {
        ...
        /// </summary>
        [SecurityCritical]
        public static void ChangeTheme(Window window, string themeName)
        {
            if (window == null)
            {
        ...
        [SecurityCritical]
        public static void ChangeTheme(Application app, Theme newTheme)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        /// <param name="newTheme">The theme to apply.</param>
        [SecurityCritical]
        public static void ChangeTheme(Window window, Theme newTheme)
        {
            if (window == null)
            {
                throw new ArgumentNullException(nameof(window));
        ...
        [SecurityCritical]
        public static void ChangeTheme(ResourceDictionary resources, Theme newTheme)
        {
            if (resources == null)
            {
                throw new ArgumentNullException(nameof(resources));
        ...
        [SecurityCritical]
        public static void ChangeThemeBaseColor(ResourceDictionary resources, string baseColor)
        {
        ...
        public static Theme DetectTheme(Window window)
        {
            if (window == null)
            {
                throw new ArgumentNullException(nameof(window));
        ...
        public static Theme DetectTheme(Application app)
        {
            if (app == null)
            {
                throw new ArgumentNullException(nameof(app));
        ...
        private static Theme DetectTheme(ResourceDictionary resources)
        {
            if (resources == null)
            {
                throw new ArgumentNullException(nameof(resources));
